...
<nav class="nav">
  <ul>
       <li><a class="scrollable batch" href="#about-me">&#xF170</a></li>
       <li><a class="scrollable batch" href="#projects">&#xF146</a></li>
       <li><a class="scrollable batch" href="#contact">&#xF150</a></li>
  </ul>
</nav>
<!-- END NAV -->
</section>
...
<div id="about-me-main" class="group">
  <div class="content">
    <a class="scrollable batch" href="#main-header">&#xF148</a><br>
    <h1>WHO I AM</h1>
    <a class="scrollable batch" href="#projects">&#xF149</a><br>
    <p class="body-text">
...
<section id="projects">
  ...
  <div class="content">
    ...
    <a class="scrollable batch" href="#contact">&#xF149</a>
...
<section id="contact" class="group">
  ...
  Interested in working with me?<br>Please get in touch, I would love to hear from you!
    ...
    <a href="mailto:katie@janekporter.com" class="button">Email</a>
